...
from model.core_module import CoreModule
...
class TransformerModulator(nn.Module):
    def __init__(self, dim, num_heads, num_part):
        ...
        self.hsi1 = CoreModule(content_channels=6, style_channels=6)
        self.hsi2 = CoreModule(content_channels=6, style_channels=6)
    ...
    def forward(self, query_feat, key_feat, value_feat, block_idx):
        ...
        cc_ss = self.hsi1(query_feat, key_feat)
        attended_value = self.hsi2(cc_ss, value_feat)
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, cnt_dynamics, cnt_mask=None):
